                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="top-contact list-text-white  d-table">
                                <li><a href="#"><i class="fas fa-phone-alt text-success mr-1"></i>+33 7 61 38 46 05</a></li>
                                <li><a href="#"><i class="fas fa-envelope text-success mr-1"></i>Contact@sema-france.fr</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4">
                            <div class="top-contact float-right">
								...
								| </li>
								<li><i class="fas fa-user-plus text-success mr-1"></i><a href="register.php">S'enregistrer</li><?php } ?>
								</ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <nav class="navbar navbar-expand-lg navbar-light p-0"> <a class="navbar-brand position-relative" href="index.php"><img class="nav-logo" src="images/logo/restatelg.png" alt=""></a>
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul class="navbar-nav mr-auto">
                                        ...
                                        <li class="nav-item"> <a class="nav-link" href="property.php">Biens</a> </li>
									...
									<a class="btn btn-success d-none d-xl-block" style="border-radius:30px;" href="submitproperty.php">Soumettre un Bien</a> 
                                </div>
                            </nav>
                        </div>
                    </div>
