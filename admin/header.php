						...
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li><a href="userlist.php"> Utilisateurs </a></li>
									<li><a href="useragent.php"> Agent </a></li>
									<li><a href="userbuilder.php"> Constructeur </a></li>
								</ul>
							</li>
							<li class="menu-title"> 
								<span>Generateur de PDF</span>

							</li>
							
							<li class="submenu">
								<a href="#"><i class="fe fe-user"></i> <span> Generer un pdf </span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li><a href="generatepdf.php"> Generer </a></li>
									<li><a href="visualiser.php"> Visiualiser </a></li>
								</ul>
							</li>
							<li class="menu-title"> 
								<span>État et ville</span>
							</li>
						
							<li class="submenu">
								<a href="#"><i class="fe fe-location"></i> <span>État et ville</span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li><a href="stateadd.php"> État </a></li>
							...
							<li class="submenu">
								<a href="#"><i class="fe fe-map"></i> <span> Bien</span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
									<li><a href="propertyadd.php"> ajouter un Bien</a></li>
									<li><a href="propertyview.php"> visualiser un Bien </a></li>
