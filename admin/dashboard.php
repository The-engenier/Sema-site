...
<head>
        ...
        <title>Le 8 - Tableau de bord</title>
							...
							<div class="card">
								<div class="card-body">
									...
									<h3><?php $sql = "SELECT * FROM property where type = 'apartment'";
										...
										<h6 class="text-muted">No. d'apartement</h6>
										<div class="progress progress-sm">
											<div class="progress-bar bg-info w-50"></div>
										</div>
									</div>
							...
							<div class="card">
								<div class="card-body">
									...
									<h3><?php $sql = "SELECT * FROM property where type = 'house'";
										...
										<h6 class="text-muted">No. de Maison</h6>
										<div class="progress progress-sm">
											<div class="progress-bar bg-info w-50"></div>
										</div>
									</div>
							...
							<div class="card">
								<div class="card-body">
									...
									<h3><?php $sql = "SELECT * FROM property where type = 'building'";
										...
										<h6 class="text-muted">No. de bâtiments</h6>
										<div class="progress progress-sm">
											<div class="progress-bar bg-info w-50"></div>
										</div>
									</div>
							...
							<div class="card">
								<div class="card-body">
									...
									<h3><?php $sql = "SELECT * FROM property where type = 'flat'";
										...
										<h6 class="text-muted">No. d'appartements</h6>
										<div class="progress progress-sm">
											<div class="progress-bar bg-info w-50"></div>
										</div>
									</div>
							...
							<div class="card">
								<div class="card-body">
									...
									<h3><?php $sql = "SELECT * FROM property where stype = 'sale'";
										...
										<h6 class="text-muted">En vente</h6>
										<div class="progress progress-sm">
											<div class="progress-bar bg-info w-50"></div>
										</div>
									</div>
