...
{
    $aid = $_GET['id'];
    // Escape user input to prevent SQL errors and injection
    ...
    if($result == true)
    {
        $msg="<p class='alert alert-success'>À propos mis à jour</p>";
        header("Location:aboutview.php?msg=$msg");
    }
    else{
        $msg="<p class='alert alert-warning'>À propos non mis à jour</p>";
        header("Location:aboutview.php?msg=$msg");
    }
}
?>
...
<head>
        ...
        <title>Ventura - Formulaire Vertical</title>
