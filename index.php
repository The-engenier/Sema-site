                            ...
                            <form method="post" action="propertygrid.php">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-lg-2">
                                        <div class="form-group">
                                            <button type="submit" name="filter" class="btn btn-success w-100">Rechercher</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Acheter votre futur bien immobilier en toute confiance, au meilleur prix du marché</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Trouver rapidement un logement à louer adapté a votre budget et vos besions</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Explorez toutes nos annonces immobilières, filtres intelligents et informations complètes à disposition</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Optimiser votre patrimoine avec des biens rentables, clés en main pour investisseurs avisés</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <!--- <div class="col-md-6">
                        <ul class="nav property-btn float-right" id="pills-tab" role="tablist">
                            <li class="nav-item"> <a class="nav-link py-3 active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Nouveau</a> </li>
                            <li class="nav-item"> <a class="nav-link py-3" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">En Vedette</a> </li>
                            <li class="nav-item"> <a class="nav-link py-3" id="pills-contact-tab2" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">Meilleure Vente</a> </li>
                            <li class="nav-item"> <a class="nav-link py-3" id="pills-contact-tab3" data-toggle="pill" href="#pills-resturant" role="tab" aria-controls="pills-contact" aria-selected="false">Vente Populaire</a> </li>
                        </ul>
                    </div> --->
<div class="col-md-12">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="featured-thumb hover-zoomer mb-4">
                        <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                            <div class="featured bg-success text-white">Nouveau</div>
                            <div class="sale bg-success text-white text-capitalize">À <?php $frenchy = $row['5'];if ($frenchy == 'sale') {echo "Vendre";} else {echo "Louer";}?></div>
                        ...
                        <div class="featured-thumb-data shadow-one">
                            ...
                            <div class="bg-gray quantity px-4 pt-4">
                                <ul>
                                    ...
                                    <li><span><?php echo $row['7'];?></span> Salles de bain</li>
                                    <li><span><?php echo $row['9'];?></span> Cuisines</li>
                                    <li><span><?php echo $row['8'];?></span> Balcons</li>
                                </ul>
                            </div>
                ...
                <div class="living-list pr-4">
                    ...
                    <ul>
                        <li class="mb-4 text-white d-flex"> 
                            ...
                            <div class="pl-2">
                                <h5 class="mb-3">Très Bien Noté</h5>
                                <p>Nos clients nous recommandent pour notre sérieux, réactivité et exellence dans chaque transaction.</p>
                            </div>
                        </li>
                        <li class="mb-4 text-white d-flex"> 
                            <i class="flaticon-real-estate flat-medium float-left d-table mr-4 text-success" aria-hidden="true"></i>
                            <div class="pl-2">
                                <h5 class="mb-3">Qualité Supérieure</h5>
                                <p>Nous offrons des services personnalisés, transparents et haut de gamme à chaque étape de votre projet.</p>
                            </div>
                        </li>
                        <li class="mb-4 text-white d-flex"> 
                            ...
                            <div class="pl-2">
                                ...
                                <p>Notre équipe d'agents chevronnés vous accompagne avec expertise, écoute et parfaite connaissance du marché.</p>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="icon-thumb-one text-center mb-5">
                    ...
                    <p>Nous échangeons avec vous pour comprendre vos besions et définir précisément votre projet immobilier idéal.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="icon-thumb-one text-center mb-5">
                    ...
                    <h5 class="text-secondary mt-5 mb-4">Examen des Dossiers</h5>
                    <p>Nous analysons chaque dossier avec rigeur pour garantir fiabilité, solvabilité et conformité aux exigences légales.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="icon-thumb-one text-center mb-5">
                    ...
                    <p>Nous vous accompagnons jusqu'a la signature final pour sécuriser l'achat ou la location de votre bien.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="count-num text-success my-4" data-speed="3000" data-stop="<?php 
                                        ...
                                        echo $total;?>">0</div>
                        <?php } ?>
                    <div class="text-white h5">Propriétés Disponibles</div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="flaticon-house flat-large text-white" aria-hidden="true"></i>
                    ...
                    <div class="count-num text-success my-4" data-speed="3000" data-stop="<?php 
                                        ...
                                        echo $total;?>">0</div>
                        <?php } ?>
                    <div class="text-white h5">Propriétés en Vente</div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="flaticon-house flat-large text-white" aria-hidden="true"></i>
                    ...
                    <div class="count-num text-success my-4" data-speed="3000" data-stop="<?php 
                                        ...
                                        echo $total;?>">0</div>
                        <?php } ?>
                    <div class="text-white h5">Propriétés à Louer</div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i class="flaticon-man flat-large text-white" aria-hidden="true"></i>
                    ...
                    <div class="count-num text-success my-4" data-speed="3000" data-stop="<?php 
                                        ...
                                        echo $total;?>">0</div>
                        <?php } ?>
                    <div class="text-white h5">Utilisateurs Inscrits</div>
                </div>
            </div>
                ...
                <div class="col-md-6 col-lg-3 pb-1">
                    <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/1.jpg" alt="">
                        <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                            ...
                            <span><?php 
                                        $total = $row[0];
                                        echo $total;?> Propriétés listées</span> </div>
                            <?php } ?>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3 pb-1">
            ...
            <div class="col-lg-12">
                <div class="content-sidebar p-4">
                    <div class="mb-3 col-lg-12">
                        <h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4">Témoignages</h4>
